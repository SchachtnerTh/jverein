...
public class EinstellungControl extends AbstractControl
{
  ...
  private IntegerInput qrcodebottompos;

  private IntegerInput qrcodeleftpos;
  ...
  /**
   * Verschl�sselte Datei f�r besonders sensible Daten (Passw�rter)
   */
  ...
  public ScaleInput getSEPADatumOffset() throws RemoteException
  {
    ...
    sepadatumoffset.setName("Zus�tzliche SEPA-Vorlaufzeit");
  ...
  public CheckboxInput getAutoBuchunguebernahme() throws RemoteException
  {
    ...
    autobuchunguebernahme
        .setName("Automatische Buchungs�bernahme aus Hibiscus");
    return autobuchunguebernahme;
  }
  ...
  public CheckboxInput getUnterdrueckungOhneBuchung() throws RemoteException
  {
    ...
    unterdrueckungohnebuchung
        .setName("Listen: Buchungsarten ohne Buchung unterdr�cken");
    return unterdrueckungohnebuchung;
  }
  ...
  public SelectInput getSepaVersion() throws RemoteException
  {
    ...
    sepaversion.setPleaseChoose("Bitte ausw�hlen");
    return sepaversion;
  }
  ...
  public SelectInput getCt1SepaVersion() throws RemoteException
  {
    ...
    ct1sepaversion.setPleaseChoose("Bitte ausw�hlen");
    return ct1sepaversion;
  }
  ...
  public CheckboxInput getCreateQRCode() throws RemoteException
  {
    ...
    {
      createqrcode = new CheckboxInput(
          Einstellungen.getEinstellung().getCreateQRCode());
    }
    return createqrcode;
  }
  ...
  public IntegerInput getQRCodePositionLeftInMm() throws RemoteException
  {
    ...
    {
      qrcodeleftpos = new IntegerInput(
          Einstellungen.getEinstellung().getQRCodePositionLeftInMm());
    }
  ...
  public IntegerInput getQRCodePositionBottomInMm() throws RemoteException
  {
    ...
    {
      qrcodebottompos = new IntegerInput(
          Einstellungen.getEinstellung().getQRCodePositionBottomInMm());
    }
