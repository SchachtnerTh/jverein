...
public class EinstellungImpl extends AbstractDBObject implements Einstellung
{
  ...
  /**
   * settings speichert Benutzer-Pr�ferenzen in einer config-Datei. Sie
   * unterscheiden sich also auf jedem System und h�ngen nicht an der DB.
   */
  ...
  {
    throw new ApplicationException("Einstellung darf nicht gel�scht werden");
  }
      ...
      if (getDokumentenspeicherung())
      {
        if (!JVereinPlugin.isArchiveServiceActive())
        {
          throw new ApplicationException(
              "Plugin jameica.messaging ist nicht installiert oder im LAN verf�gbar! Wird zur Dokumentenspeicherung ben�tigt!");
        }
      }
      try
      {
  ...
  // TODO f�r Versionsbau deaktivert.
  // @Override
  ...
  public String getQRCodeInfoM() throws RemoteException
  {
    ...
    {
      return "Vielen Dank f�r Ihre Spende!";
    }
